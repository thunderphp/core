 ...
 * @copyright   Copyright (c) 2015 DIVANTE (http://divante.pl)
 */

namespace Core\Filters\Validator;

class Email extends BasicDataValidator
{
    var $email = null;
    ...
    public function __construct($email, $pattern = null)
    {
        if(empty($email)) {
            // @ TODO Exception
    ...
    {
        if($this->email($this->email) && $this->regex($this->email, $this->pattern)) {
            return true;
        }
